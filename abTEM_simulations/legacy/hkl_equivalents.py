...
# Scaffolding for enumerating non-equivalent [hkl] realizations under
# distorted-cubic symmetries (orthorhombic / monoclinic / rhombohedral, all
# viewed as distortions of a parent cubic cell with an abc <-> a'b'c' relation
# table). drop_negatives is the Friedel-pair deduper; gen_hkl is the
# zone-axis-perpendicular enumerator; uvw_to_hkl is the direction converter.
#
# Recovered from `simulation_lib.py` before deletion in 5f944f2-era cleanup
# (drop_negatives at 60345d9, gen_hkl + uvw_to_hkl at b41024a). gen_hkl and
# uvw_to_hkl were already triple-quoted in V.'s working file; preserved
# verbatim here. drop_negatives was executable and is kept as a live function.
